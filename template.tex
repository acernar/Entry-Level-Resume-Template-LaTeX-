...
~
	\smartdiagram[bubble diagram]{
        \textbf{Director}\\\textbf{Proyectos},
        \textbf{Cloud}\\\textbf{\&}\\\textbf{SaaS},
         \textbf{~~~~~~Cloud~~~~~~}\\\textb,
         \textbf{~~~~~~IT~~~~~~}\\\textbf{~~Security~~},
        \textbf{~~~~~~BI~~~~~~},
        \textbf{~~~~~DevOps~~~~~}
    }
}
...
\programming{{Agile $\textbullet$ Scrum  $\textbullet$ Strategic Planning / 4}, {Project Scheduling $\textbullet$ Business Process $\textbullet$  / 3.5}, {Leadership $\textbullet$ Communication $\textbullet$ Project / 6}}


% Projects text
\education{
\textbf{Mag., Gerencia Tecnologías de la Información y Comunicaciones}  \\
Grado: Estudiante Maestría \\
Universidad Privada Antenor Orrego \\
2018 - 2019 | Trujillo, Peru

\textbf{Ing., Electrónica}  \\
Grado: Ingeniero Electrónico \\
Universidad Privada Antenor Orrego \\
1991 - 1997 | Trujillo, Peru
}
...
\cvname{ALEX CERNA} % Your name
\cvjobtitle{ Ingeniero Electrónico } % Job
% title/career

\cvlinkedin{/in/alexcerna}
\cvgithub{acernar}
\cvnumberphone{(+51) 98738 5884} % Phone number
\cvsite{escbusiness.com/alexcerna/} % Personal website
\cvmail{acernar@gmail.com} % Email address
